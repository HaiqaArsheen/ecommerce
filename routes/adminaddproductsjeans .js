...
router.post('/submit-jeansform', (req, res) => {
  ...
  const uploadDir = path.join(__dirname, '../img/jeans');
  ...
  const query = `INSERT INTO jeans (name, price, description, image1, image2, image3) VALUES (?, ?, ?, ?, ?, ?)`;
  console.log(query);
...
router.post('/update-product/:id', (req, res) => {
  ...
  let updateQuery = 'UPDATE jeans SET name = ?, price = ?, description = ?';
